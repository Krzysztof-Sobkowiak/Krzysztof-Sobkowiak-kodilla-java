package com.kodilla.patterns.hotel;
...
public class HotelApp {
    public static void main(String[] args) {
        ...
        System.out.println("   - holdiay season: " + Season.HOLIDAY.getSingleRoomPrice());
        ...
        System.out.println("   - holdiay season: " + Season.HOLIDAY.getDoubleRoomPrice());
